/**
* Advanced Player Links for BF4 - Add some advanced player links to the profile.
*
* @author I-MrFixIt-I + Elementofprgress
* @version 0.1
...
BBLog.handle("add.plugin", {
    ...
    */
    id : "fix-bf4-advanced-player-links",
    ...
    * @type String
    */
    name : "Advanced Player Links for BF4",
    ...
    domchange : function(instance){
        if (instance.storage("use.player-links"))
        {
            if (!$( "#advanced-player-links" ).length) {
                ...
                var leaderboard = $("#overview-info div[class=box]");
                leaderboard.find(".clear").remove(); // remove "clear"-div and insert it later again
                
                var html = leaderboard.html();
                html += "<div class='box-content no-padding leaderboard-highlight'>"
                      + "<div id='advanced-player-links'>";

                html += "<div class='description'>•</div>";
                //http://history.anticheatinc.com/bf4/index.php?searchvalue=elementofprgress

                if (instance.storage("use.ACI")) html += "<div class='description'><a href='http://history.anticheatinc.com/bf4/index.php?searchvalue=" + soldierName + "' target='_blank'>ACI</a></div>"
                ...
                if (instance.storage("use.BF4DB")) html += "<div class='description'><a href='http://bf4db.com/players?name=" + soldierName + "' target='_blank'>BF4DB</a></div>"
                                                                + "<div class='description'>•</div>";
                ...
                if (instance.storage("use.Google")) html += "<div class='description'><a href='https://www.google.de/#q=%22" + soldierName + "%22' target='_blank'>Google</a></div>"
                                                                + "<div class='description'>•</div>"

                html += "</div><div class='clear'></div></div>"; // add "clear"-div again
